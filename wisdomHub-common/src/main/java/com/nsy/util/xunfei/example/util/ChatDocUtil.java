package com.nsy.util.xunfei.example.util;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.nsy.util.xunfei.example.dto.UploadResp;
import com.nsy.util.xunfei.example.dto.chat.ChatMessage;
import com.nsy.util.xunfei.example.dto.chat.ChatRequest;
import okhttp3.*;
...
public class ChatDocUtil {
    ...
    public String getRequestUrl(String chatUrl, String appId, String secret){
